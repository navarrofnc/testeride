    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            if (jsonObject.getJSONObject("custom").has("ride_request")) {
                ...
                paymentMode = jsonObject.getJSONObject("custom").getJSONObject("ride_request").getString("payment_mode")
                ...
                tvPaymentMethod.text=getString(R.string.payment_methods)+": "+paymentMode
...
//                    etd_distance.text = resources.getString(R.string.distance)+": "+etdDistance + " km"
                    etd_distance.text = etdDistance + " km"
                } else {

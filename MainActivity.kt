...
import com.rideincab.user.taxi.views.splash.SplashActivity.Companion.checkVersionModel
        ...
        geoQuery?.addGeoQueryEventListener(object : GeoQueryEventListener {
            ...
            override fun onKeyEntered(key: String?, location: GeoLocation?) {
                ...
                if (!isTrip) {
                    ...
                    drawMarker(LatLng(location!!.latitude, location.longitude), sessionManager.carType, key)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S)
           if (ContextCompat.checkSelfPermission( this, Manifest.permission.POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED) {
                when{
                    ...
                    else-> ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.POST_NOTIFICATIONS), 5)
                }
        }
    }
    /**
